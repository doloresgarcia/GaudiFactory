...
`datamc_chg_costheta.pdf`, `datamc_chg_pmag.pdf`, `datamc_chg_ntpc.pdf`,
`datamc_chg_d0.pdf`, `datamc_chg_z0.pdf`, `datamc_missp.pdf`.
...
`datamc_pwflag2_pmag.pdf`, `datamc_pwflag5_pmag.pdf`,
